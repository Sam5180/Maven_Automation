...
//    public static String CaptureText(WebDriver driver, WebElement locator, int index, String elementName, ExtentTest logger) throws IOException, InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, 10);
//        String text = null;
//        try {
...
//    }
    ...
    public static void dropDownByText(WebDriver driver, WebElement locator, int index, String userValue, ExtentTest loggers, String elementName) throws IOException, InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        ...
        try {
            ...
            element = wait.until(ExpectedConditions.visibilityOfAllElements(locator)).get(index);
